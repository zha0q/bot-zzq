...
function connect(callback) {
  ...
  const refresh = () => {
    ...
    closeTimer = +setTimeout(() => value == null ? void 0 : value.close(), config.heartbeat.timeout);
  };
  const reconnect = () => {
    socket.value = null;
...
import Button from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/common/k-button.vue";
import Filter from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/common/k-filter.vue";
import FilterButton from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/common/k-filter-button.vue";
import Form from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/common/k-form.vue";
import Tab from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/common/k-tab.vue";
...
import Schema from "D:/workplace/bot-zzq/node_modules/schemastery-vue/src/schema.vue";

// node_modules/schemastery-vue/src/icons/index.ts
import IconClose from "D:/workplace/bot-zzq/node_modules/schemastery-vue/src/icons/close.vue";
import IconEllipsis from "D:/workplace/bot-zzq/node_modules/schemastery-vue/src/icons/ellipsis.vue";
import IconExternal from "D:/workplace/bot-zzq/node_modules/schemastery-vue/src/icons/external.vue";
import IconEyeSlash from "D:/workplace/bot-zzq/node_modules/schemastery-vue/src/icons/eye-slash.vue";
import IconEye from "D:/workplace/bot-zzq/node_modules/schemastery-vue/src/icons/eye.vue";
...
import ChatImage from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/chat/image.vue";
...
import Default from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/activity/default.vue";
import Ellipsis from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/activity/ellipsis.vue";
import Home from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/activity/home.vue";
import Moon from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/activity/moon.vue";
import Sun from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/activity/sun.vue";
import BoxOpen from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/box-open.vue";
import CheckFull from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/check-full.vue";
import ChevronDown from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/chevron-down.vue";
import ChevronLeft from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/chevron-left.vue";
import ChevronRight from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/chevron-right.vue";
import ChevronUp from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/chevron-up.vue";
import ClipboardList from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/clipboard-list.vue";
import Delete from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/delete.vue";
import Edit from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/edit.vue";
import ExclamationFull from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/exclamation-full.vue";
import Expand from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/expand.vue";
import FileArchive from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/file-archive.vue";
import Filter2 from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/filter.vue";
import GitHub from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/github.vue";
import GitLab from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/gitlab.vue";
import InfoFull from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/info-full.vue";
import Koishi from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/koishi.vue";
import Link from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/link.vue";
import PaperPlane from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/paper-plane.vue";
import QuestionEmpty from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/question-empty.vue";
import Redo from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/redo.vue";
import Search from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/search.vue";
import SearchMinus from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/search-minus.vue";
import SearchPlus from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/search-plus.vue";
import StarEmpty from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/star-empty.vue";
import StarFull from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/star-full.vue";
import Start from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/start.vue";
import Tag from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/tag.vue";
import TimesFull from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/times-full.vue";
import Tools from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/tools.vue";
import Undo from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/undo.vue";
import User from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/svg/user.vue";
import "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/icons/style.scss";
var registry = {};
...
import Layout from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/layout/k-layout.vue";
import Status from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/layout/k-status.vue";
import CardNumeric from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/layout/card-numeric.vue";
import Card from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/layout/card.vue";
import Content from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/layout/content.vue";
import Empty from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/layout/empty.vue";
import TabGroup from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/layout/tab-group.vue";
import TabItem from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/layout/tab-item.vue";
...
import Badge from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/notice/badge.vue";
import Comment2 from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/notice/comment.vue";
import Hint from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/notice/hint.vue";
...
// node_modules/@koishijs/client/client/components/index.ts
import "D:/workplace/bot-zzq/node_modules/element-plus/dist/index.css";

// node_modules/@satorijs/components/src/chat/index.ts
import ChatInput from "D:/workplace/bot-zzq/node_modules/@satorijs/components/src/chat/input.vue";
import MessageContent from "D:/workplace/bot-zzq/node_modules/@satorijs/components/src/chat/content.vue";

// node_modules/@satorijs/components/src/popper/index.ts
import Dropdown from "D:/workplace/bot-zzq/node_modules/@satorijs/components/src/popper/dropdown.vue";
import Popper from "D:/workplace/bot-zzq/node_modules/@satorijs/components/src/popper/popper.vue";
import Tooltip from "D:/workplace/bot-zzq/node_modules/@satorijs/components/src/popper/tooltip.vue";
...
import VirtualList from "D:/workplace/bot-zzq/node_modules/@satorijs/components/src/virtual/list.vue";
...
import Overlay from "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/components/chat/overlay.vue";
...
// node_modules/@koishijs/client/client/index.ts
import "D:/workplace/bot-zzq/node_modules/@koishijs/client/client/styles/index.scss";
